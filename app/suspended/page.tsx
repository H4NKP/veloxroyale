        ...
        <div className="min-h-screen bg-pterodark flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md z-10">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-pterotext tracking-tight mb-2">{t('accountSuspendedTitle')}</h1>
                    <p className="text-pterosub text-sm">{t('accountSuspendedDesc')}</p>
                </div>
